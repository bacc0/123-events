...
//         <div className="app-container">
//             <link
//                 rel="stylesheet" href="/universal-styles.css"
//             />
//             {currentView === 'dashboard' ? (
//                 <main className="main-content">
...
//                     <div className="card card-padded">
//                         <div
//                             className="section-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%', flexWrap: 'wrap', gap: '12px' }}
//                         >
//                             <div
